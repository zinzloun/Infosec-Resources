...
# 2 Lunch the attack* providing the password to test: Get-Spray

# *The function generate a list of domain users as a file (if not present), then execute the attack
